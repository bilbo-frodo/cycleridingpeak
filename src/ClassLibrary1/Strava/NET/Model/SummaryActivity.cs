...
namespace Strava.NET.Model {
  ...
  public class SummaryActivity {
    ...
    //public ActivityType Type { get; set; }  // todo how to convert to ActivityType - going with string for now
    ...
    public int? WeightedAverageWatts { get; set; }
        ...
        /// Has heart rate
        /// </summary>
        /// <value>Has heart rate</value>
        [DataMember(Name = "has_heartrate", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Calories consumed</value>
        [DataMember(Name = "calories", EmitDefaultValue = false)]
        [JsonProperty(PropertyName = "calories")]
        public float? Calories { get; set; }

        public bool HighestSpeed { get; set; }

        public int ActivitiesThisMonth { get; set; }

        public float? TotalDistanceThisMonth { get; set; }

        public int AverageSpeedPosition { get; set; }

        public int AverageHrPosition { get; set; }

        public int MaxHrPosition { get; set; }
